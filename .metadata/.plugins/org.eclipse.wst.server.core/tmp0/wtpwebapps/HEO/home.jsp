	...
	<div class="am-g am-container">
		<div class="am-u-sm-12 am-u-md-12 am-u-lg-8">
			<div data-am-widget="slider" class="am-slider am-slider-c1"
				...
				<ul class="am-slides">
					<li><a href="events_show.html"><img src="images/bb1.jpg"></a>
		...
		<div class="am-u-sm-0 am-u-md-0 am-u-lg-4 padding-none">
			<div class="star am-container">
				<span><img src="images/star.png">今日热点</span>
			</div>
			<ul
				...
				<li>
					<div class="am-gallery-item">
						<a href="#"> <img src="images/demoimg.JPG"
							alt="远方 有一个地方 那里种有我们的梦想"
							style="width: 200.66px; height: 171.36px" />
...
<div class="am-container">
	<ul
		...
		<li>
			<div class="am-gallery-item">
				<a href="news.html"> <img src="images/tempnews.png"
					alt="远方 有一个地方 那里种有我们的梦想" />
					<h3 class="am-gallery-title">远方 有一个地方 那里种有我们的梦想</h3>
					<div class="am-gallery-desc">2375-09-26</div>
				</a>
		...
		<li>
			<div class="am-gallery-item">
				<a href="#"> <img src="images/tempnews.png"
					alt="远方 有一个地方 那里种有我们的梦想" />
					<h3 class="am-gallery-title">远方 有一个地方 那里种有我们的梦想</h3>
					<div class="am-gallery-desc">2375-09-26</div>
				</a>
			...
			<div class="am-list-news-bd">
				<ul class="am-list">
					<li
						...
						<div class="am-u-sm-5 am-list-thumb">
							<a href="http://www.douban.com/online/11624755/"> <img
								src="images/bb2.jpg" alt="我最喜欢的一张画" />
							</a>
					...
					<div class="newsico am-fr">
						<i class="am-icon-clock-o">2016/11/11</i> <i
			...
			<div class="am-hide-sm">
				...
				<div id="youxi" class="case am-animation-slide-left">
					<ul
						...
						<li>
							<div class="am-gallery-item">
								<a href="images/bottom.jpg"> <img src="images/bottom2.jpg"
									data-replace-img="images/bottom.jpg" alt="远方 有一个地方 那里种有我们的梦想" />
									<h3 class="am-gallery-title">远方 有一个地方 那里种有我们的梦想</h3>
									<div class="am-gallery-desc">2375-09-26</div>
								</a>
							</div>
			...
			<ul class="am-list">
				<li
					...
					<div class="am-u-sm-4 am-list-thumb">
						<a href="http://www.douban.com/online/11624755/"> <img
							src="images/face3.jpg" class="face" />
						</a>
					</div>
